...
- [ ] Ship Replacement plugin (F23), as AA's srp: SRP fleets, members submit losses by killmail link, reviewers approve, reject or adjust payouts, totals per fleet (killmail values need a new outbound source: ask first)
