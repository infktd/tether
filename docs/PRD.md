...
- [ ] Fleet Activity Tracking plugin (F23), as AA's fleetactivitytracking: FCs create a FAT link for a fleet (and, with the fleet scope, add everyone in the ESI fleet), members click it to record their character's attendance, and stats per member, corporation and month
