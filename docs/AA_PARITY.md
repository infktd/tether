...
| AA SRP, AFAT | AFAT's additions (alliance stats, fleet types, expiring links, ESI-tracked fleets, logs) are in the Fleet Activity Tracking plugin | SRP: planned plugin; AFAT: done (above) |
