...
const API_ROUTES: &[(&str, &str)] = &[
    ...
    ("post", "/api/me/main"),
    ("get", "/api/tokens"),
    ("post", "/api/tokens/{character_id}/refresh"),
    ...
    ("post", "/api/groups/{id}/retract"),
    ("get", "/api/group-management/requests"),
    (
        "post",
    ...
    ("get", "/api/group-management/groups/{id}/audit-log"),
    ("post", "/api/admin/groups"),
    ("put", "/api/admin/groups/{id}"),
    ("delete", "/api/admin/groups/{id}"),
    ("post", "/api/admin/groups/{id}/members"),
    ("delete", "/api/admin/groups/{id}/members/{account_id}"),
    ("put", "/api/admin/groups/{id}/leaders/{account_id}"),
    ...
    ("post", "/api/admin/reserved-group-names"),
